...
//
//    @Before(
//            value = "com.github.vincemann.springrapid.core.SystemArchitecture.fullUpdateOperation() && " +
//                    "com.github.vincemann.springrapid.acldemo.UserPointCuts.serviceOperation() && " +
...
//        System.err.println("matching full update USER SERVICE");
...
//
//        System.err.println("SETTING RELATIONAL USER SERVICE CONTEXT: " + joinPoint.getTarget() + "->" + joinPoint.getSignature().getName());
//
//
