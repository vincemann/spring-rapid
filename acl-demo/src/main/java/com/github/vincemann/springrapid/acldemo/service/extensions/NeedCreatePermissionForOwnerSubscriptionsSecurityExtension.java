...
public class NeedCreatePermissionForOwnerSubscriptionsSecurityExtension extends SecurityServiceExtension<VisitService>
        implements GenericCrudServiceExtension<VisitService, Visit,Long>, VisitService
{
    ...
    public void subscribeOwner(Owner owner, Visit visit) {
        getSecurityChecker().checkPermission(visit.getId(),visit.getClass(),getCreatePermission());
