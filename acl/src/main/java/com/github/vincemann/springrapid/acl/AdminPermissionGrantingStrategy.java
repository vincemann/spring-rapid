 ...
 */
public class AdminPermissionGrantingStrategy extends DefaultPermissionGrantingStrategy {

    private final Log log = LogFactory.getLog(AdminPermissionGrantingStrategy.class);

    private final transient AuditLogger auditLogger;

    public AdminPermissionGrantingStrategy(AuditLogger auditLogger) {
        super(auditLogger);
