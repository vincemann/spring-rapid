...
public interface AclPermissionService {
    ...
    /**
     * see {@link this#inheritPermissionsForUser(IdentifiableEntity, IdentifiableEntity, String, Permission...)} but for all permissions.
     */
     ...
     */
    void inheritPermissions(IdentifiableEntity<?> targetObj, IdentifiableEntity<?> parent, Permission... permissions) throws AclNotFoundException;
     ...
     */
    void inheritPermissionsForUser(IdentifiableEntity<?> targetObj, IdentifiableEntity<?> parent, String user) throws AclNotFoundException;
     ...
     */
    void inheritPermissionsForUser(IdentifiableEntity<?> targetObj, IdentifiableEntity<?> parent, String user, Permission... permissions) throws AclNotFoundException;
}
