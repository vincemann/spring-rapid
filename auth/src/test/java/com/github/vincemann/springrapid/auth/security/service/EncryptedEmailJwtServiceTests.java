package com.github.vincemann.springrapid.auth.security.service;

import com.github.vincemann.springrapid.auth.service.token.BadTokenException;
import com.github.vincemann.springrapid.auth.service.token.EmailJwtService;
import com.github.vincemann.springrapid.auth.service.token.EncryptedEmailJwtService;
import com.github.vincemann.springrapid.auth.service.token.RapidJweService;
...
@Slf4j
public class EncryptedEmailJwtServiceTests {
	...
	private RapidJweService jweService1;
	private RapidJweService jweService2;
//	private LemonJwsService jwsService1;
//	private LemonJwsService jwsService2;

	private EncryptedEmailJwtService emailService1;
	private EncryptedEmailJwtService emailService2;

	public EncryptedEmailJwtServiceTests() throws JOSEException {
		
		jweService1 = new RapidJweService(SECRET1);
		emailService1 = new EncryptedEmailJwtService();
		emailService1.injectJweTokenService(jweService1);

		jweService2 = new RapidJweService(SECRET2);
		emailService2 = new EncryptedEmailJwtService();
...
//		jwsService2 = new LemonJwsService(SECRET2);
	...
	private void testParseToken(EncryptedEmailJwtService service) throws BadTokenException {
	...
	public void testParseJweTokenWrongAudience() {
		Assertions.assertThrows(AccessDeniedException.class,() -> testParseTokenWrongAudience(emailService1));
	}
...
//	}
	...
	private void testParseTokenWrongAudience(EncryptedEmailJwtService service) throws BadTokenException {
	...
	public void testParseJweTokenExpired() throws InterruptedException {
		...
		Assertions.assertThrows(AccessDeniedException.class,() -> testParseTokenExpired(emailService1));
	}
...
//	}
	...
	private void testParseTokenExpired(EncryptedEmailJwtService service) throws InterruptedException, BadTokenException {
...
//	}
	...
	public void testParseJweTokenCutoffTime() throws InterruptedException {
		...
		Assertions.assertThrows(AccessDeniedException.class,() -> testParseTokenCutoffTime(emailService1));
	}
