...
public interface UniDirParent extends DirEntity {
     ...
     * @return
     */
    default Map<Collection<IdentifiableEntity>, Class<IdentifiableEntity>> findUniDirChildCollections()  {
     ...
     * @return
     */
    default Set<IdentifiableEntity> findSingleUniDirChildren() {
     ...
     */
    default void linkUniDirChild(IdentifiableEntity newChild) throws UnknownChildTypeException{
     ...
     * @throws UnknownChildTypeException
     */
    default void unlinkUniDirChild(IdentifiableEntity toRemove) throws UnknownChildTypeException{
