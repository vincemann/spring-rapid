...
import com.github.vincemann.springrapid.entityrelationship.controller.dtomapper.biDir.testEntities.BiDirEntityParentDto;
...
public class BiDirParentIdResolverTest extends BiDirEntityResolverTest {
    ...
    public void resolveServiceEntityIds() throws EntityNotFoundException, BadEntityException {
        ...
        //when
        biDirParentIdResolver.injectEntitiesFromDtoIds(unfinishedMappedBiDirEntityParent,biDirEntityParentDto);
        //then
    ...
    public void resolveDtoIds(){
        ...
        //when
        biDirParentIdResolver.injectDtoIdsFromEntity(unfinishedMappedBiDirEntityParentDto,entityParent);
        //then
