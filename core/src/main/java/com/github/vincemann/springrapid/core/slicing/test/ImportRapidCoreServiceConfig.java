...
//import rapid core config that is relevant for service tests
        BootstrapAutoConfiguration.class, CrudServiceLocatorAutoConfiguration.class, LogInteractionAutoConfiguration.class, ReflectionCacheAutoConfiguration.class
})
