 ...
 */
public interface UniDirChild extends DirEntity {
     ...
     */
    default Collection<UniDirParent> findSingleUniDirParents() {
     ...
     */
    default void linkUniDirParent(UniDirParent parentToSet) throws UnknownParentTypeException {
     ...
     */
    default void unlinkUniDirParent(UniDirParent parentToDelete) throws UnknownParentTypeException {
