 ...
 *
 * In the end this leads to almost the same error response, regardless whether exception is thrown in controller or other framework-inter components like filters.
 */
@Slf4j
