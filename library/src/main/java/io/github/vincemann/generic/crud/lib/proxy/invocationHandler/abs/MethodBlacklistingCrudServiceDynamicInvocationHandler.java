...
@Setter
@Slf4j
public abstract class MethodBlacklistingCrudServiceDynamicInvocationHandler<E extends IdentifiableEntity<Id>,Id extends Serializable>
        implements InvocationHandler
{
    ...
    public MethodBlacklistingCrudServiceDynamicInvocationHandler(CrudService<E, Id, CrudRepository<E, Id>> service, String... ignoredMethods) {
