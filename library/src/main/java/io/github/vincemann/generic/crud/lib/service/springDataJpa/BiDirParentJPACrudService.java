...
public abstract class BiDirParentJPACrudService<E extends IdentifiableEntity<Id> & BiDirParent,Id extends Serializable & Comparable,R extends JpaRepository<E,Id>> extends JPACrudService<E,Id,R> {
