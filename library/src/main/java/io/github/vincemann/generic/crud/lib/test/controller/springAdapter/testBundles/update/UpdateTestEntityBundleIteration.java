...
@Getter
public class UpdateTestEntityBundleIteration<Dto extends IdentifiableEntity> {
     ...
     *
     * This will only be used for update Tests. For other Tests see {@link UpdateTestEntityBundle}.
     */
    @Nullable
    private TestRequestEntityModification testRequestEntityModification;

    public UpdateTestEntityBundleIteration(Dto modifiedEntity) {
        this.modifiedEntity = modifiedEntity;
    }

    @Builder
    public UpdateTestEntityBundleIteration(Dto modifiedEntity, PostUpdateCallback<Dto> postUpdateCallback, @Nullable TestRequestEntityModification testRequestEntityModification) {
        this.modifiedEntity = modifiedEntity;
