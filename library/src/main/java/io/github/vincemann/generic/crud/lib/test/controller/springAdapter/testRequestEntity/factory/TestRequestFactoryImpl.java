...
public class TestRequestFactoryImpl implements TestRequestEntityFactory {
    ...
    public TestRequestFactoryImpl(UrlParamIdDtoCrudControllerSpringAdapterIT crudControllerTest, DefaultUriFactory defaultUriFactory, TestRequestEntityModificationStrategy testRequestEntityModificationStrategy) {
        this.crudControllerTest = crudControllerTest;
    ...
    private RequestMethod mapTestCaseToHttpMethod(CrudControllerTestCase crudControllerTestCase){
        DtoCrudControllerSpringAdapter crudController = crudControllerTest.getCrudController();
