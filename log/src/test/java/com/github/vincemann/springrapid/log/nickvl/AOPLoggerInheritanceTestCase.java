...
import com.github.vincemann.springrapid.log.nickvl.service.ExtendedBarService;
...
@ContextConfiguration(value = "/com.github.vincemann.springrapid.log.nickvl/AOPLoggerInheritanceTestCase-context.xml")
@DirtiesContext
