...
@Getter
@Setter
public class ReadOwnOverviewOwnerDto extends AbstractOwnerDto {
    ...
    public ReadOwnOverviewOwnerDto(String address, String city, String telephone, Set<String> hobbies, String dirtySecret, @Nullable Set<Long> petIds, String lastName, Long clinicCardId) {
