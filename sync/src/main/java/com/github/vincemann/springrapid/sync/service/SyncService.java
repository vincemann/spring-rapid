...
public interface SyncService<E extends IAuditingEntity<Id>,Id extends Serializable> {
     ...
     *
     * @param clientLastUpdate info about when client performed last fetch|update for specific entity
    ...
    /**
     * Finds sync statuses for all entities updated since {@code clientLastUpdate} timestamp.
     ...
     *
     * @param clientLastUpdate timestamp client performed last update of all entities
